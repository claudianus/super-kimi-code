...
| UltraGoal | UltraPlan이 구체적 목표, 완료 기준, 검증 계획을 고정한 뒤 시작합니다. |
| UltraSwarm | ENGAGE/DEFER Swarm decision이 보일 때만 specialist subagent를 투입합니다. |
| UltraWork | 목표형 작업을 UltraPlan, UltraGoal, research, Swarm decision, integration, verification, learning 순서로 라우팅합니다. |
