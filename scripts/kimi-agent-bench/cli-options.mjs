...
export function usage() {
  return `Usage: node scripts/kimi-agent-bench.mjs [options]

Internal Super Kimi agent benchmark and bounded improvement loop.
...
Examples:
  node scripts/kimi-agent-bench.mjs --suite seed
  node scripts/kimi-agent-bench.mjs --suite guard --expect-status QUARANTINED
  node scripts/kimi-agent-bench.mjs --loop --max-iterations 2
  node scripts/kimi-agent-bench.mjs --runner ultrawork --suite holdout
  node scripts/kimi-agent-bench.mjs --runner provider --suite holdout
`;
}
