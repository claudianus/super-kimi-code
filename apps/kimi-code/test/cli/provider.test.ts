...
import type { KimiConfig, ProviderRouteStatus } from '@moonshot-ai/kimi-code-sdk';
...
describe('kimi provider custom add', () => {
...
describe('kimi provider key add', () => {
...
describe('kimi provider key management', () => {
...
describe('kimi provider oauth management', () => {
