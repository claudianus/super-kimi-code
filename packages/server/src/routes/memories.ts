import { IMemoryService, type IInstantiationService, type MemoryCreateInput, type MemoryListRequest, type MemoryRecord as CoreMemoryRecord, type MemorySearchRequest, type MemorySourceRef, type MemoryUpdateInput } from '@moonshot-ai/agent-core';
import {
  ...
  const listRoute = defineRoute(
    {
      ...
      description: 'List Kimi Recall memories',
      tags: ['memories'],
  ...
  const searchRoute = defineRoute(
    {
      ...
      description: 'Search Kimi Recall memories',
      tags: ['memories'],
  ...
  const createRoute = defineRoute(
    {
      ...
      description: 'Create a Kimi Recall memory',
      tags: ['memories'],
  ...
  const getRoute = defineRoute(
    {
      ...
      description: 'Get a Kimi Recall memory',
      tags: ['memories'],
  ...
  const updateRoute = defineRoute(
    {
      ...
      description: 'Update a Kimi Recall memory',
      tags: ['memories'],
  ...
  const deleteRoute = defineRoute(
    {
      ...
      description: 'Forget a Kimi Recall memory',
      tags: ['memories'],
  ...
  const statsRoute = defineRoute(
    {
      ...
      description: 'Get Kimi Recall memory stats',
      tags: ['memories'],
  ...
  const exportRoute = defineRoute(
    {
      ...
      description: 'Export Kimi Recall memories',
      tags: ['memories'],
  ...
  const importRoute = defineRoute(
    {
      ...
      description: 'Import Kimi Recall memories',
      tags: ['memories'],
  ...
  const consolidateRoute = defineRoute(
    {
      ...
      description: 'Consolidate duplicate Kimi Recall memories',
      tags: ['memories'],
